...
class TransactionRedeem extends StatefulWidget {
  final _bizz;
  final _dollar;
  final _address;
  final _url;

  TransactionRedeem(this._bizz, this._dollar, this._address, this._url);
  @override
  _TransactionRedeemState createState() => _TransactionRedeemState(
      this._bizz, this._dollar, this._address, this._url);
}

class _TransactionRedeemState extends State<TransactionRedeem> {
  final _bizz;
  final _dollar;
  final _address;
  final _url;
  _TransactionRedeemState(this._bizz, this._dollar, this._address, this._url);
      ...
      body: loading == false
          ? Container(
              ...
              child: SingleChildScrollView(
                ...
                //   ),
                //   child: FlatButton(
                //     onPressed: () => this.onBetaV(context),
                //     color: const Color(0xff0c0a0a),
  ...
  void onCopyPressed(BuildContext context) {
    Clipboard.setData(new ClipboardData(text: '$_url')).then((value) {
